...
def remove_spaces(text):
    ...
    stage1 = text[count_leading(text):]
    stage2 = stage1[::-1]
    stage3 = stage2[count_leading(stage2):]
    stage4 = stage3[::-1]
...
def normalise_input(user_input):
    ...
    'help'
    """
    stage1 = remove_punct(user_input)
    stage2 = remove_spaces(stage1)
    stage3 = stage2.lower()
...
def menu(exits):
    ...
    while True:
        ...
        # Read player's input
            ans = input()
        # Normalise the input
            norm_ans = normalise_input(ans)
        # Check if the input makes sense (is valid exit)
            if is_valid_exit(exits, norm_ans):
                return norm_ans
            else:
